...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'shrouded-harbor-70828-55c317b38622.herokuapp.com']
...
AWS_STORAGE_BUCKET_NAME = config('AWS_STORAGE_BUCKET_NAME', default='shareif-recipe-app')
